...
public abstract class DataFieldBase extends GridPane {
...
//    protected AppAxisChartWrapper appAxisChartWrapper;
    ...
    public DataFieldBase(ObservableList<Node> children, AppSeries appSeries, int dataIndex){
...
//            appSeries.removeData(dataIndex);
