...
//
//            if(bufferSize.get()==2){
////                print(((Line) buffer.get(0).styleableNode));
////                print(buffer.get(0).styleableNode.getOnMouseDragged());
//                buffer.get(0).styleableNode.setOnMouseMoved(mouseEvent -> {
//                    print(uuid(10));
//                });
//                buffer.get(1).styleableNode.setOnMouseMoved(mouseEvent -> {
//                    print(uuid(20));
//                });
//            }
