...
public class AppLegend extends GridPane implements JSONSerializable, SVGSerializable , TeXSerializable {
...
//    public final SimpleDoubleProperty centerHeight = new SimpleDoubleProperty();
    ...
    public final SimpleDoubleProperty topMargin = new SimpleDoubleProperty(0.2);
    public final SimpleDoubleProperty bottomMargin = new SimpleDoubleProperty(0.2);
    public final SimpleDoubleProperty leftMargin = new SimpleDoubleProperty(0.2);
    public final SimpleDoubleProperty rightMargin = new SimpleDoubleProperty(0.2);
...
//        }
////        for (int i = 0; i < container.getChildren().size(); i+=3) {
////            stringBuilder.append("\n").append("\t".repeat(tabIndent)).append((AppNode));
////        }
...
//        container.maxHeightProperty().bindBidirectional(centerHeight);
    ...
    public void addSeries(int seriesIndex, Group appSeriesVisualLegend, Label appSeriesTitle) {
        Rectangle newEmptySpace = new Rectangle();
        newEmptySpace.widthProperty().bindBidirectional(titleVisualMargin);
        container.addRow(seriesIndex, appSeriesVisualLegend, newEmptySpace, appSeriesTitle);
    }
