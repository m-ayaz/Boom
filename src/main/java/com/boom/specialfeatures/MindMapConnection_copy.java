 ...
 */
public class MindMapConnection_copy extends SVGPath {
...
//        l2Right.bind(circle2.radiusProperty());
    ...
    public DoubleBinding l1Leftp = squared(rLeft).divide(l1Left);
    public DoubleBinding hLeft = sqrt(squared(rLeft).divide(squared(l1Left)).negate().add(1)).multiply(rLeft);
    public DoubleBinding l2Leftp = l1Left.subtract(middleThickness.divide(2).multiply(sqrt(squared(l1Left).divide(squared(rLeft)).subtract(1))));
...
//    public DoubleProperty l2Rightp = new SimpleDoubleProperty();
    ...
    public DoubleProperty distance=sqrt(squared(centerX1.subtract(centerX2)).add(squared(centerY1.subtract(centerY2))));
...
//    public void customize(){}
    ...
    public MindMapConnection_copy(DoubleProperty radius1, DoubleProperty radius2, DoubleProperty centerX1, DoubleProperty centerY1, DoubleProperty centerX2, DoubleProperty centerY2, DoubleProperty factorLeft, DoubleProperty factorRight) {
