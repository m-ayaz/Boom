...
public class Test70 extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        print(appDataList);
        appDataList.sort(comp1);
        print(appDataList);
        appDataList.sort(comp2);
        print(appDataList);
        ...
        pane.setBackground(Background.fill(Color.valueOf("00000088")));

        setCustomSize(pane,600,600);


//        setCustomSize(popup.set,600,600);
...
class Comp implements Comparator<AppData>{
